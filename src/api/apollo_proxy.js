...
export const fetchOwnerProductProperties = (data) =>
  apolloClient.query({
    query: gql`
      query FetchOwnerProductProperties(
        $token: String!
        $from: String!
        $to: String!
        $perPage: Int
...
export const fetchGeodata = (data) =>
  apolloClient.query({
    query: gql`
...
export const deleteGeodata = (data) =>
  apolloClient.mutate({
    mutation: gql`
